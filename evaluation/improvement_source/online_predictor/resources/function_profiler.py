...
class FunctionProfiler:
    ...
    def __generate_exec_time_profiler(self):
        with open("function_profilers/execution_time_profiler.json", "r") as f:
            function_exec_time_profilers = json.load(f)
        running_time_profilers = function_exec_time_profilers["running_time_profiler"]
    ...
    def __generate_cs_extra_time_profiler(self):
        with open("function_profilers/cs_extra_times.json", "r") as f:
