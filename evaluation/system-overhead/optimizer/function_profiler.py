...
class FunctionProfiler:
    def __init__(self):
        ...
        self.cpu_cs_extra_time_profilers, self.gpu_cs_extra_time_profilers = (
            self.__generate_cs_extra_time_profiler()
        )
    ...
    def __generate_exec_time_profiler(self):
        ...
        running_time_profilers = eval(
            function_exec_time_profilers["running_time_profiler"]
        )
    ...
    def __generate_cs_extra_time_profiler(self):
        with open(
            os.path.join(SCRIPT_DIR, "function_profilers/cs_extra_times.json"), "r"
        ) as f:
            function_cs_extra_time_profilers = json.load(f)
        cs_time = json.loads(function_cs_extra_time_profilers["cs_time"])
        ...
        return function_cpu_cs_extra_time, function_cuda_cs_extra_time
    ...
    def get_cpu_cost_running_time(
        ...
        cost = self.resource_cost(cpu_resource)
        return (
