...
REQUEST_FILE = "request/questionanswering.json"
...
@register_invoker
class QuestionAnswering(InferenceInvoker):
    def invoke(self, args):
        ...
        for req in request_config:
            ...
            r = session.get(
                url, data=json.dumps(request_config[req]), allow_redirects=False, headers=header
            )
