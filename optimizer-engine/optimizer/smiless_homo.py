...
from .path_search_no_cuda import PathSearchNoCuda
...
class SMIlessHomo(Optimizer):
    def __init__(
        ...
        self.path_search_no_cuda = PathSearchNoCuda()
    ...
    def get_workflow_running_plan_df(
        ...
        for df in graph_dfs:
            ...
            self.path_search_no_cuda.init(df, shared_nodes, SLA, self.IT)
            df = self.path_search_no_cuda.get_running_plan_df()
