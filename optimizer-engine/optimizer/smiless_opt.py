...
from .path_search_opt import PathSearchOPT
...
class SMIlessOPT(Optimizer):
    def __init__(
        ...
        self.path_search_opt = PathSearchOPT()
    ...
    def get_workflow_running_plan_df(
        ...
        for df in graph_dfs:
            ...
            self.path_search_opt.init(df, shared_nodes, SLA, self.IT)
            df = self.path_search_opt.get_running_plan_df()
