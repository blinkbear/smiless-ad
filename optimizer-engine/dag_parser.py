...
class DAGParser:
    ...
    def set_function_info(self, function_info):
        self.function_info = function_info

    def generate_workflow_dag(self, workflow_name, workflow_dag_json):
        workflow_dag = nx.DiGraph()
        self.workflow_sla[workflow_name] = workflow_dag_json["SLA"]
